...
$EQUIPMENT_RENT_QUOTATION = new EquipmentRentQuotation(NULL);

// Get the quotation number from document tracking table
$DOCUMENT_TRACKING = new DocumentTracking($doc_id);
$lastId = $DOCUMENT_TRACKING->equipment_rent_quotation_id;
$quotation_number = 'ERQ/' . $_SESSION['id'] . '/0' . ($lastId + 1);
?>

<head>

    <meta charset="utf-8" />
    <title>Equipment Rent Quotation |
...
<body data-layout="horizontal" data-topbar="colored" class="someBlock">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 text-md-end text-start mt-3 mt-md-0">
                            <ol class="breadcrumb m-0 justify-content-md-end">
                                ...
                                <li class="breadcrumb-item active">Equipment Rent Quotation</li>
                            </ol>
                        </div>
                    </div>
 ...
 <!-- container-fluid -->
    ...
    <!-- Quotation Modal -->
    <div id="QuotationModal" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog"
        aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Manage Equipment Rent Quotations</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <table id="quotationTable" class="table table-bordered dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>#ID</th>
