...
<head>
    <meta charset="utf-8" />
    <title>Supplier Outstanding Payment | <?php echo $COMPANY_PROFILE_DETAILS->name ?> </title>
...
<body data-layout="horizontal" data-topbar="colored">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Supplier Outstanding Payment</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-4">Select Supplier or Invoice</h5>
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            <label class="form-label">Supplier</label>
                                            <div class="input-group">
                                                <input id="supplier_code" name="supplier_code" type="text" placeholder="Select Supplier" class="form-control" readonly>
                                                <input type="hidden" id="supplier_id" name="supplier_id">
                                                <button class="btn btn-info" type="button" data-bs-toggle="modal" data-bs-target="#supplierModal">
                                                    <i class="uil uil-search"></i>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">GRN / Invoice No</label>
                                            <div class="input-group">
                                                <input id="search_invoice_number" name="search_invoice_number" type="text" placeholder="Enter GRN or Invoice No" class="form-control">
                                                <button class="btn btn-info" type="button" id="searchInvoiceBtn">
                                                    <i class="uil uil-search"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="outstandingTable">
                                            ...
                                            <tbody id="outstandingTableBody">
                                                <tr>
                                                    <td colspan="6" class="text-center text-muted">Please select a supplier to view outstanding invoices.</td>
                                                </tr>
                                            </tbody>
    ...
    <!-- Page Specific JS -->
    <script src="ajax/js/supplier-outstanding-payment.js?v=<?php echo time(); ?>"></script>
