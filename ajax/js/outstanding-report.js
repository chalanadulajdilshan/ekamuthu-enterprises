...
function loadReport() {
    ...
    reportTable = $('#reportTable').DataTable({
        ...
        "drawCallback": function () {
            ...
            var totalRentPlusInitial = api.column(8, { search: 'applied' }).data().reduce(function (a, b) { return parseAmount(a) + parseAmount(b); }, 0);
            ...
            $('#cardTotalBalance').text('Rs. ' + formatAmount(totalBalance));
        },
        "footerCallback": function (row, data, start, end, display) {
            ...
            var totalRentPlusInitial = api.column(8).data().reduce(function (a, b) { return parseAmount(a) + parseAmount(b); }, 0);
            ...
            $(api.column(8).footer()).html(formatAmount(totalRentPlusInitial));
