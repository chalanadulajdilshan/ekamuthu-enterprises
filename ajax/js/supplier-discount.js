jQuery(document).ready(function () {
  ...
  $(document).on("click", ".select-model", function () {
    ...
    const suplier_code = $(this).data("suplier_code");
...
$(document).on('click', '#supplierTable tbody tr', function () {
  ...
  $('#suplier_code').val(data.code);  // Display supplier code
  $('#suplier_id').val(data.id);      // Save actual ID (hidden field)
  $('#name').val(data.name);
...
jQuery(document).ready(function () {
  ...
  // Initialize Supplier DataTable when modal opens
